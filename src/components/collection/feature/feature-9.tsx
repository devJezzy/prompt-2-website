...
const FeatureItem: React.FC<Feature> = ({ id, title, description, advantages, icon, image }) => {
  return (
...
const features: Feature[] = [
  {
    ...
    advantages: [
      { id: 1, text: "Advantage of this feature" },
      { id: 2, text: "Advantage of this feature" },
      { id: 3, text: "Advantage of this feature" },
    ],
