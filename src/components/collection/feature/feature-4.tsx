...
const FeatureItem: React.FC<FeatureItemProps> = ({ title, description, icon, color }) => {
  return (
    <div className="p-4 bg-gray-100 dark:bg-gray-900 rounded-lg space-y-3">
      ...
      <h1 className="flex text-lg font-semibold capitalize text-gray-900 dark:text-white">{title}</h1>
      <p className="text-sm font-light text-gray-700 dark:text-gray-300">{description}</p>
    </div>
  );
};
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5">
        <div className="flex flex-col lg:flex-row lg:items-center gap-8 lg:gap-10 xl:gap-14">
          ...
          <div className="flex-1 py-10 lg:py-8 space-y-8 max-w-2xl">
            <h2 className="text-4xl font-semibold text-gray-900 dark:text-white">Stay focused on your business strategy</h2>
