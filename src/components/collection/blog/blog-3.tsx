...
const BlogCard: React.FC<BlogCardProps> = ({ cover, title, summary, tags }) => {
  return (
...
const posts: Post[] = [
  {
    ...
    summary: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga incidunt nam, nihil earum animi ducimus exercitationem facilis explicabo dicta illum delectus, ipsum cum unde enim deleniti repellat. Ipsum, vitae doloremque.",
    tags: [
      {
        id: 1,
